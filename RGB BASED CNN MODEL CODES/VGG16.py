...
checkpoint = ModelCheckpoint(filepath='./vgg16_results/vgg_best_weights.tf', monitor='val_loss', save_best_only=True, mode='min',save_format="tf")
csv_logger = CSVLogger('./vgg16_results/vgg_training_log.csv')
...
model.load_weights('./vgg16_results/vgg_best_weights.tf')
